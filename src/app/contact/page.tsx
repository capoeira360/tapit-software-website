        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="contact-hero-text flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button className="bg-white/10 backdrop-blur-sm border border-white/20 text-white hover:bg-white/20 transition-all duration-300 text-lg px-8 py-4 rounded-lg">
                Schedule Call
              </button>
            </div>
          </div>
