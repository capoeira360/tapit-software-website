    ...
    <>
      ...
      >
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute top-1/3 right-1/3 w-28 h-0.5 bg-gradient-to-l from-[#C48D2E]/30 to-transparent animate-pulse delay-400" />
          <div className="absolute bottom-1/3 left-1/3 w-20 h-0.5 bg-gradient-to-r from-[#D6B456]/30 to-transparent animate-pulse delay-600" />
          <div className="absolute right-1/4 top-1/2 w-0.5 h-18 bg-gradient-to-b from-[#C48D2E]/20 to-transparent animate-pulse delay-200" />
