      ...
      >
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="portfolio-hero-text text-xl md:text-2xl text-black mb-8 max-w-3xl mx-auto leading-relaxed font-medium">
              Discover the innovative digital solutions we've crafted for businesses across various industries.
            </p>
            <div className="portfolio-hero-text flex items-center justify-center space-x-8 text-black">
