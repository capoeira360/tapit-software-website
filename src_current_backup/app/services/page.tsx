...
export default function Services() {
  ...
  return (
    <>
      ...
      >
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="services-hero-text text-xl md:text-2xl text-black mb-8 max-w-3xl mx-auto leading-relaxed font-medium">
              Comprehensive digital solutions tailored to transform your business and drive growth in the digital age.
            </p>
            <div className="services-hero-text flex items-center justify-center space-x-8 text-black font-medium">
      ...
      {/* Process Section */}
      <section ref={processRef} className="py-20 bg-gradient-dark">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-display font-bold mb-6">
