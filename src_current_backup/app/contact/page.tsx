      ...
      >
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="contact-hero-text text-xl md:text-2xl text-black mb-8 max-w-3xl mx-auto leading-relaxed font-medium">
              Ready to transform your business? Let's discuss your project and create something amazing together.
            </p>
            <div className="contact-hero-text flex items-center justify-center space-x-8 text-black font-medium">
