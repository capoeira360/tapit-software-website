      ...
      >
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="services-hero-text text-xl md:text-2xl text-text-secondary mb-8 max-w-3xl mx-auto leading-relaxed">
              Comprehensive digital solutions tailored to transform your business and drive growth in the digital age.
            </p>
            <div className="services-hero-text flex items-center justify-center space-x-8 text-text-secondary">
