...
export default function Contact() {
  ...
  const carouselSlides: CarouselSlide[] = [
    {
      ...
      description: "Ready to transform your business? Let's discuss your project and create innovative digital solutions.",
      backgroundGradient: "linear-gradient(135deg, #667eea 0%, #764ba2 100%)"
    },
    {
      title: "Free Consultation",
      subtitle: "Expert Guidance",
      description: "Get personalized advice from our experienced team with strategic recommendations at no cost.",
      backgroundGradient: "linear-gradient(135deg, #f093fb 0%, #f5576c 100%)"
    },
    {
      title: "Quick Response",
      subtitle: "Fast Service",
      description: "We value your time. Expect a response within 24 hours and let's start building your digital future.",
      backgroundGradient: "linear-gradient(135deg, #4facfe 0%, #00f2fe 100%)"
    },
    {
      title: "Global Reach",
      subtitle: "Worldwide Solutions",
      description: "From local startups to global enterprises, we deliver solutions that scale with your business.",
      backgroundGradient: "linear-gradient(135deg, #43e97b 0%, #38f9d7 100%)"
    },
    {
      title: "24/7 Support",
      subtitle: "Always Available",
      description: "Our dedicated support team is here to help you succeed with ongoing assistance and maintenance.",
      backgroundGradient: "linear-gradient(135deg, #ff9a9e 0%, #fecfef 100%)"
    },
    {
      title: "Proven Results",
      subtitle: "Success Stories",
      description: "Join hundreds of satisfied clients who have transformed their businesses with our digital solutions.",
  ...
  return (
    <>
      ...
      <section 
        ref={heroRef}
        className="relative min-h-screen overflow-hidden pt-20 bg-gradient-to-br from-primary-600 via-primary-700 to-primary-800"
      >
        {/* Background Elements */}
        <div className="absolute inset-0">
          <div className="absolute top-20 left-10 w-72 h-72 bg-white/10 rounded-full blur-3xl"></div>
          <div className="absolute bottom-20 right-10 w-96 h-96 bg-accent-500/20 rounded-full blur-3xl"></div>
          <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-gradient-to-r from-primary-400/10 to-accent-400/10 rounded-full blur-3xl"></div>
        </div>
        ...
        <div className="relative z-10 flex flex-col items-center justify-center min-h-screen text-center px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="contact-hero-text text-xl md:text-2xl text-white/90 mb-8 leading-relaxed">
              Ready to transform your business? Let's create something amazing together
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button className="bg-accent-500 hover:bg-accent-600 text-white px-8 py-4 rounded-full font-semibold transition-all duration-300 transform hover:scale-105">
                Start Project
              </button>
        ...
        <div className="absolute bottom-20 left-1/2 transform -translate-x-1/2 z-20">
          <div className="flex items-center justify-center space-x-8 text-white font-medium bg-black/20 backdrop-blur-sm rounded-full px-8 py-4">
